...
// render data into list elements on page
const renderList = (state) => {
    // removing the first child in the array each time page is re-rendered
...
// render list that feeds the renderList function
const render = () => {
